      ...
      {!isReader && (
        <>
          ...
          <div className="flex gap-2">
            <input value={luogo} onChange={(e) => setLuogo(e.target.value)} placeholder="Serve andare in un posto specifico? (opzionale)"
            ...
            <button onClick={handleAdd} style={{ width: 38, height: 38, borderRadius: 10, backgroundColor: C.purple, border: "none", flexShrink: 0 }}><Plus size={16} color="#0a0b0f" /></button>
          </div>
        </>
      )}
    </Sheet>
