...
export default function SearchSheet({ workspace, onClose, bumpRefresh, readOnly }) {
  ...
  return (
    <Sheet onClose={onClose} title="Cerca transazioni">
      ...
      {editing && (
        <TransactionModal workspace={workspace} existing={editing} zIndex={55} onClose={() => setEditing(null)} onSaved={handleEditDone} onDeleted={handleEditDone} readOnly={readOnly} />
      )}
    </Sheet>
  );
}
