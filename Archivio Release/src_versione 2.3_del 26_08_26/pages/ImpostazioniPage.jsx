...
export default function ImpostazioniPage() {
  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: 28 }}><ProfiloTab member={member} user={user} signOut={signOut} /></div>

      {workspace && (
        <>
          <SezioneLabel>Workspace</SezioneLabel>
          <div style={{ marginBottom: 28 }}><WorkspaceGeneraleTab workspace={workspace} isAdmin={isAdmin} /></div>
        </>
      )}
