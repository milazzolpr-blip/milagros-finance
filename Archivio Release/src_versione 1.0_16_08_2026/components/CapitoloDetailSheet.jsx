...
export default function CapitoloDetailSheet({ capitolo, workspaceId, members, onClose }) {
        ...
        <>
          ...
          <div className="space-y-2.5">
            {transazioni.map((t) => {
              ...
              return (
                <div key={t.id} className="flex items-center gap-3" style={isDup ? { backgroundColor: "rgba(251,191,36,0.08)", border: `1px solid rgba(251,191,36,0.35)`, borderRadius: 10, padding: 8 } : { padding: "0 2px" }}>
