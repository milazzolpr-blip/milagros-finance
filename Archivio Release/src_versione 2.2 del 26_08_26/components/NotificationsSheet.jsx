...
import { Receipt, Clock, CalendarPlus, Baby, BellOff } from "lucide-react";
import { C } from "../theme";
import { Sheet } from "./ui";
import { supabase } from "../lib/supabase";

const ICONE = { scadenza: Receipt, turno: Clock, evento: CalendarPlus, figlio: Baby };
const COLORI = { scadenza: C.amber, turno: C.sky, evento: C.violet, figlio: C.orange };
