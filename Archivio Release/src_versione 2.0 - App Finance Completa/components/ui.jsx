...
import { User, Plus, Home, Calendar, BookOpen, BarChart3, Settings, X, Search, ChevronDown } from "lucide-react";
...
export function Header({ onAdd, onSearch, onWorkspaceClick, workspaceName, hideAdd }) {
